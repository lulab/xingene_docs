...
|----------|-------------|----------|----------|
| **肿瘤信号** | **0.25**   |    0 - 0.86  | <img src="/reports/img/score-low.webp" style="zoom:30%;" /> |
...
| **检测类型** | **实测值**    | **正常人参考区间**<sup>（注）</sup> | **<font style="color:green">阴性</font>** |
|----------|-------------|----------|----------|
| **肺部** | **0.02**   |    0 - 0.052 | <img src="/reports/img/score-low.webp" style="zoom:30%;" /> |
| **结直肠** | **0.06**   |    0 - 0.165   | <img src="/reports/img/score-low.webp" style="zoom:30%;" /> |
| **胃** | **0.02**   |    0 - 0.066    | <img src="/reports/img/score-low.webp" style="zoom:30%;" /> |
| **肝脏** | **0.1**   |    0 - 0.482  | <img src="/reports/img/score-low.webp" style="zoom:30%;" /> |
| **食管** | **0.03**   |    0 - 0.095   | <img src="/reports/img/score-low.webp" style="zoom:30%;" /> |
...
我们的计算基于您的血样中的高达**几十亿碱基对**的测序量，加上专有的 AI 模型，包含了如下图所示的**4个主要模块的数十道工序**。各个中间步骤的具体结果文件可以从 [附录：全部文件下载链接](#files) 中获取。
