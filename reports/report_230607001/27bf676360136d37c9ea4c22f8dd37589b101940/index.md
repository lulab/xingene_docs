...
**上述肿瘤信号强度是由我们专有的 AI 模型基于您的转录组中的几万个基因计算而来，您的全转录组基因表达值的总图表如下：**
...
我们的计算基于您的血样中的高达**几十亿（~2-3G）碱基对**的测序量，加上我们专有的 AI 模型，包含了如下图所示的**4个主要模块的数十道工序**。各个中间步骤的具体结果文件可以从 [附录：全部文件下载链接](#files) 中获取。
