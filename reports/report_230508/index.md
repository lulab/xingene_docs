...
* 您本次检测的最终评估结果为 **阴性**
* 您体内的肿瘤信号强度为 **0.23**  （正常人参考区间为： 0 - 2.3，特异性为95%）

<img src="../img/score-0.23.webp" style="zoom:25%;" />

具体请参见以下说明：

### 1. 体内肿瘤信号强度评估

* 本报告中的肿瘤信号强度指的是您的血液样本中癌症相关基因CYTOR（细胞骨架调节子RNA）相对参考基因GAPDH（甘油醛-3-磷酸脱氫酶）的丰度水平，计算公式为2^[-△Ct(CYTOR-GAPDH)]，该值越高，表明血液中的肿瘤信号强度越强，正常人的参考区间为： **0 - 2.3，特异性为95%**。
...
<img src="../img/compare.webp" style="zoom: 33%;" />
